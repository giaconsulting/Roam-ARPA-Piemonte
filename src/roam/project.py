...
class Project(object):
    ...
    def from_folder(cls, rootfolder):
        ...
        if 'plugins' in project.settings:
            if 'export_plugin' not in project.settings['plugins']:
                project.settings['plugins']=project.settings['plugins']+['export_plugin']
        else:
            project.settings['plugins']=['export_plugin']
        return project
