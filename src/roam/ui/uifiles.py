...
from roam.ui import (ui_projectwidget, ui_listmodules, ui_helpviewer,
                 ...
                 ui_legend, ui_mapwidget, ui_annotationdock, ui_layerlist)
...
annotationdock_widget, annotationdock_base = ui_annotationdock.Ui_Form, QWidget
layerlist_widget, layerlist_base = ui_layerlist.Ui_LayerList, QDialog
