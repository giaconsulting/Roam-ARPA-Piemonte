...
# Form implementation generated from reading ui file 'c:\sviluppo\Roam\src\roam\editorwidgets\uifiles\ui_drawingpad.ui'
#
...
class Ui_DrawingWindow(object):
    def setupUi(self, DrawingWindow):
        ...
        DrawingWindow.setProperty(_fromUtf8("modal"), False)
        DrawingWindow.resize(896, 583)
        DrawingWindow.setStyleSheet(_fromUtf8("* {\n"
"    color: #4f4f4f;\n"
"    font: 14pt \"Segoe UI\" ;\n"
...
"        QToolButton::checked { \n"
"            padding: 6px;\n"
"    background-color: rgba(85, 85, 255, 50);\n"
"         }    "))
        ...
        self.toolClear.setIconSize(QtCore.QSize(48, 48))
        ...
        self.toolMapSnapshot.setIconSize(QtCore.QSize(48, 48))
        ...
        self.toolRedPen.setIconSize(QtCore.QSize(48, 48))
        ...
        self.toolBluePen.setIconSize(QtCore.QSize(48, 48))
        ...
        self.toolBlackPen.setIconSize(QtCore.QSize(48, 48))
        ...
        self.colorPickerButton = QtGui.QToolButton(DrawingWindow)
        self.colorPickerButton.setIconSize(QtCore.QSize(48, 48))
        self.colorPickerButton.setCheckable(True)
        self.colorPickerButton.setAutoRaise(True)
        self.colorPickerButton.setObjectName(_fromUtf8("colorPickerButton"))
        self.buttonGroup.addButton(self.colorPickerButton)
        self.horizontalLayout_2.addWidget(self.colorPickerButton)
        self.toolEraser = QtGui.QToolButton(DrawingWindow)
        self.toolEraser.setIconSize(QtCore.QSize(48, 48))
        ...
        self.toolCancel.setIconSize(QtCore.QSize(48, 48))
        ...
        self.toolSave.setIconSize(QtCore.QSize(48, 48))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/widgets/red")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/widgets/black")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/save")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, DrawingWindow):
        ...
        self.toolMapSnapshot.setText(QtGui.QApplication.translate("DrawingWindow", "Map Snapshot", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.colorPickerButton.setText(QtGui.QApplication.translate("DrawingWindow", "Pick Colour", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionRedPen.setText(QtGui.QApplication.translate("DrawingWindow", "Red", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionBluePen.setText(QtGui.QApplication.translate("DrawingWindow", "Blue", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionBlackPen.setText(QtGui.QApplication.translate("DrawingWindow", "Black", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionMapSnapshot.setText(QtGui.QApplication.translate("DrawingWindow", "Map Snapshot", None, QtGui.QApplication.UnicodeUTF8))
